...
| **QWEN CLI**                  | 무료로 사용할 수 있는 Qwen 기반 코딩 CLI 도구 | [Visit](https://github.com/QwenLM)                      |
| **nomotron-speech-streaming** | 실시간 스트리밍 기반 오픈소스 음성 인식(STT)    | [Visit](https://github.com)                             |
| **Supertonic**                | 텍스트 음성 변환(TTS) 기술, 하이브 자회사     | [Visit](https://supertonic.ai/)                         |
...
| **Twilio**        | SMS, Voice, Email을 위한 통신 API 플랫폼 | [Visit](https://www.twilio.com/)              |
